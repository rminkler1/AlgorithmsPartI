...
public class BitonicSearch {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i <= 10; i++) {
            System.out.println(i + " in a: " + search(a, i));
        }
        System.out.println("566 in b: " + search(b, 566));
        System.out.println("1 in b: " + search(b, 1));
        System.out.println("10 in b: " + search(b, 10));
        System.out.println("44 in b: " + search(b, 44));
        System.out.println("10 in c: " + search(c, 10));
        for (int i = 10; i <= 110; i += 10) {
            System.out.println(i + " in c: " + search(c, i));
        }
        for (int i = 0; i <= 20; i++) {
            System.out.println(i + " in c: " + search(c, i));
        }

        System.out.println("10 in d: " + search(d, 10));
        System.out.println("50 in d: " + search(d, 50));
        System.out.println("11 in d: " + search(d, 11));

        for (int i = 0; i <= 200; i++) {
            System.out.println(i + " in e: " + search(e, i));
        }
